  ...
  return (
    <section className="px-6 py-12 max-w-7xl mx-auto">
      ...
      <Link to="/full-map" className="block group">
        <div className="relative rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-all duration-500 animate-scaleIn delay-200">
          <iframe
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent flex items-center justify-center group-hover:from-black/30 transition-all duration-500">
            <div className="bg-[#FF7A00] hover:bg-[#E66D00] text-white px-10 py-5 rounded-full text-lg font-bold flex items-center gap-3 shadow-lg group-hover:opacity-90 transition-all duration-300">
