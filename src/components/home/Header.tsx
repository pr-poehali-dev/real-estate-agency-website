  ...
  return (
    <header className="px-4 md:px-6 py-3 md:py-4 flex items-center justify-between max-w-7xl mx-auto">
      ...
      <nav className="flex items-center gap-3 md:gap-10 animate-fadeInUp delay-100">
        ...
        <a href="#contact" onClick={handleContactLinkClick} className="hidden sm:block text-sm md:text-base text-gray-600 hover:text-gray-900 transition-colors cursor-pointer">Контакты</a>
        <Button 
